...
function playRound(playerSelection, computerSelection) {
    if (playerSelection === computerSelection) {
        ...
        result.insertAdjacentHTML('beforeend', "You lost this round!!");
        aiScore++;
        return 'lose'
    }
}
...
function addEvent(button) {
    button.addEventListener('click', function(e) {
        ...
        result.innerHTML = "Computer picked: <img src='icons/" + aiPick + ".png'><br/>";
...
function didWeWin() {
    if (playerScore == 5) {
        ...
        Array.from(playerButton).map(i => hideItem(i));
        winMsg.innerHTML = "Looks like you lost!"
        showItem(winMsg);
    }
}
